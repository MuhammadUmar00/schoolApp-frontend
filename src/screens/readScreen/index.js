...
import { ImageBackground, Dimensions, Text, View, TouchableOpacity } from 'react-native';
        ...
        <View style={readStyles.container}>
            ...
            >
                <View style={readStyles.layer}>
                    <Text style={readStyles.imageText}>
                        {screenDetails.name}
                    </Text>
                </View>
            </ImageBackground>
            <View style={readStyles.card}>
                <View style={readStyles.textDiv}>
                    ...
                    <Text style={readStyles.cardText}>
                        Basic 7 Science
                    </Text>
                </View>
            </View>
            <View style={readStyles.card2}>
                <View style={readStyles.textDiv}>
                    ...
                    <Text style={readStyles.cardText2}>
                        All Term
                    </Text>
                </View>
